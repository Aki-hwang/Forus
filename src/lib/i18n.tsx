...
const STRINGS: Record<string, Str> = {
  ...
  topClinics: S("조회수 TOP 클리닉", "再生数TOPクリニック", "播放量TOP诊所", "Top clinics by views"),
  topPosts: S("조회수 TOP 게시물", "再生数TOP投稿", "播放量TOP帖子", "Top posts by views"),
  popTreatments: S("인기 시술", "人気施術", "热门项目", "Top treatments"),
  contentTypes: S("콘텐츠 유형", "コンテンツ種類", "内容类型", "Content types"),
  statCollected: S("수집된 광고", "収集した広告", "已收集广告", "Ads collected"),
  statNew: S("🆕 신규 광고", "🆕 新規広告", "🆕 新增广告", "🆕 New ads"),
  statTop: S("🔥 최다 조회", "🔥 最多再生", "🔥 最高播放", "🔥 Most viewed"),
  ...
  emptyPosts: S("집행된 게시물이 없어요.", "投稿がありません。", "没有帖子。", "No posts."),
